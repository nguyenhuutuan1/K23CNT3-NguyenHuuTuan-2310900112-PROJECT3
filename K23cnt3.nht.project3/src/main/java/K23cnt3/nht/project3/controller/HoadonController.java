...
import K23cnt3.nht.project3.service.HoadonService;
import K23cnt3.nht.project3.service.KhachhangService;
import K23cnt3.nht.project3.service.NhanvienService;
    ...
    public String saveHoadon(@ModelAttribute Hoadon hoadon,
        ...
        for (int i = 0; i < sanphamIds.size(); i++) {
            ...
            if (quantity != null && quantity > 0) {
                // Tạo đối tượng Sanpham chỉ với ID
